...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <link rel="apple-touch-icon" sizes="72x72" href="{{asset('assets/favicon.png')}}" />
        <link rel="apple-touch-icon" sizes="114x114" href="{{asset('assets/favicon.png')}}" />
                    ...
                    if (tpj("#rev_slider_26_1").revolution == undefined) {
                        ...
                        revapi263 = tpj("#rev_slider_26_1")
                            ...
                            .revolution({
                                ...
                                responsiveLevels: [1240, 1025, 778, 650,500,450,400],
                                visibilityLevels: [1920, 1500, 1025, 768,650,500,450,400],
