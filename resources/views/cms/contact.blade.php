                ...
                <form action="{{ route('contactStore') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="pb-4">
                            ...
                            <input type="text" class="form-control" id="title_header" name="title_header"
                                value ="{{ $contact->title_header }}" />
                        </div>

                        <div class="pb-4">
                            <label for="subtitle_header" class="form-label">SubTitle </label>
                            <input type="text" class="form-control" id="subtitle_header" name="subtitle_header"
                                value ="{{ $contact->subtitle_header }}" />
                        </div>

                        <div class="pb-4 col-md-6">
                            @if ($contact->background)
                                <img src="{{ asset('assets/contact/' . $contact->background) }}" height="100"
                                    class="d-block">
                            @endif
                        ...
                        <div class="pb-4 col-md-6">
                            @if ($contact->logo_contact)
                                <img src="{{ asset('assets/contact/' . $contact->logo_contact) }}" height="100"
                                    class="d-block">
                            @endif
                            <label for="logo_contact" class="form-label">Image </label>
                    ...
                    <div class="row">
                        ...
                        <div class="pb-4">
                            ...
                            <input type="text" class="form-control" id="title_career" name="title_career"
                                value ="{{ $contact->title_career }}" />
                        </div>

                        <div class="pb-4">
                            <label for="subtitle_career" class="form-label">SubTitle Career</label>
                            <input type="text" class="form-control" id="subtitle_career" name="subtitle_career"
                                value ="{{ $contact->subtitle_career }}" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="pb-4">
                            ...
                            <input type="text" class="form-control" id="title_address" name="title_address"
                                value ="{{ $contact->title_address }}" />
                        </div>

                        <div class="pb-4">
                            <label for="subtitle_address" class="form-label">SubTitle Address</label>
                            <input type="text" class="form-control" id="subtitle_address" name="subtitle_address"
                                value ="{{ $contact->subtitle_address }}" />
                        </div>
                        <div class="pb-4 col-md-6">

                            @if ($contact->image_address)
                                <img src="{{ asset('assets/contact/' . $contact->image_address) }}" height="100"
                                    class="d-block">
                            @endif
                            <label for="image_address" class="form-label">image </label>
                    ...
                    <div class="row">
                        <div class="pb-4 col-md-6">
                            @if ($contact->icon_lb)
                                <img src="{{ asset('assets/contact/' . $contact->icon_lb) }}" height="100"
                                    class="d-block">
                            @endif
                            <label for="icon_lb" class="form-label">Icon </label>
                    ...
                    <div class="row">
                        <div class="pb-4 col-md-6">
                            @if ($contact->icon_jordan)
                                <img src="{{ asset('assets/contact/' . $contact->icon_jordan) }}" height="100"
                                    class="d-block">
                            @endif
                            <label for="icon_jordan" class="form-label">Icon </label>
                    ...
                    <div class="row">
                        <div class="pb-4 col-md-6">
                            @if ($contact->icon_cyprus)
                                <img src="{{ asset('assets/contact/' . $contact->icon_cyprus) }}" height="100"
                                    class="d-block">
                            @endif
                            <label for="icon_cyprus" class="form-label">Icon </label>
                    ...
                    <div class="pb-4">
                        ...
                        <input type="text" class="form-control" id="title_media" name="title_media"
                            value="{{ $contact->title_media }}" />
                    </div>
