                ...
                <form action="{{ route('homeStore') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="pb-4 col-md-6">
                            ...
                            @endif
                            <label for="icon1" class="form-label">Icon1</label>
                    ...
                    <div class="row">
                        ...
                        <div class="pb-4">
                            ...
                            <input type="text" class="form-control" id="subtitle3" name="subtitle3"
                                value="{{ $home->subtitle3 }}" />
                        </div>
                        {{-- <div class="pb-4 col-md-6">
                            @if ($home->icon3)
                    ...
                    <div class="row">
                        ...
                        <div class="pb-4">
                            ...
                            <input type="text" class="form-control" id="subtitle4" name="subtitle4"
                                value="{{ $home->subtitle4 }}" />
                        </div>
                        {{-- <div class="pb-4 col-md-6">
                            @if ($home->icon4)
                    ...
                    <div class="divider divider-info">
                        <div class="divider-text">Section Counter</div>
                    </div>
                    <div class="row">
                        <div class="pb-4">
                            <label for="title_year" class="form-label">Title </label>
                            <input type="text" class="form-control" id="title_year" name="title_year"
                                value="{{ $home->title_year }}" />
                        </div>
                        <div class="pb-4">
                        ...
                        <div class="pb-4">
                            ...
                            <input type="text" class="form-control" id="title1_count" name="title1_count"
                                value="{{ $home->title1_count }}" />
                        </div>

                        <div class="pb-4">
                            <label for="subtitle1_count" class="form-label">Subtitle</label>
                            <input type="text" class="form-control" id="subtitle1_count" name="subtitle1_count"
                                value="{{ $home->subtitle1_count }}" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="pb-4 col-md-6">
                            @if ($home->image_count)
                                <img src="{{ asset('assets/home/' . $home->image_count) }}" height="100"
                                    class="d-block">
                            @endif
                            <label for="image_count" class="form-label">Image </label>
                    ...
                    <div class="row">
                        ...
                        <div class="pb-4">
                            ...
                            <input type="text" class="form-control" id="title2_count" name="title2_count"
                                value="{{ $home->title2_count }}" />
                        </div>

                        <div class="pb-4">
                            <label for="subtitle2_count" class="form-label">Subtitle 2</label>
                            <input type="text" class="form-control" id="subtitle2_count" name="subtitle2_count"
                                value="{{ $home->subtitle2_count }}" />
                        </div>
                    </div>
                    ...
                    <div class="divider divider-info">
                        <div class="divider-text">Section Companies</div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 pb-4">
                            ...
                            @endif
                            <label for="company1" class="form-label">Image 1</label>
                    ...
                    <div class="row">
                        <div class="col-md-6 pb-4">
                            ...
                            @endif
                            <label for="company2" class="form-label">Image 2 </label>
                    ...
                    <div class="row">
                        <div class="col-md-6 pb-4">
                            ...
                            @endif
                            <label for="company3" class="form-label">Image 3</label>
                    ...
                    <div class="row">
                        <div class="col-md-6 pb-4">
                            ...
                            @endif
                            <label for="company4" class="form-label">Image 4 </label>
                    ...
                    <div class="pb-4">
                        ...
                        <input type="text" class="form-control" id="title_section1" name="title_section1"
                            value="{{ $home->title_section1 }}" />
                    </div>

                    <div class="pb-4">
                        <label for="text_consultancy" class="form-label">text 1</label>
                        <input type="text" class="form-control" id="text_consultancy" name="text_consultancy"
                            value="{{ $home->text_consultancy }}" />
                    </div>


                    <div class="pb-4">
                        <label for="text2_section1" class="form-label">text 2</label>
                        <input type="text" class="form-control" id="text2_section1" name="text2_section1"
                            value="{{ $home->text2_section1 }}" />
                    </div>

                    <div class="pb-4">
                        <label for="text3_section1" class="form-label">text 3</label>
                        <input type="text" class="form-control" id="text3_section1" name="text3_section1"
                            value="{{ $home->text3_section1 }}" />
                    </div>


                    <div class="pb-4">
                        <label for="text4_section1" class="form-label">text 4</label>
                        <input type="text" class="form-control" id="text4_section1"
                            name="text4_section1"value="{{ $home->text4_section1 }}" />
                    </div>

                    <div class="row">
                        <div class="pb-4 col-md-6">
                            @if ($home->image_section1)
                                <img src="{{ asset('assets/home/' . $home->image_section1) }}" height="100"
                                    class="d-block">
                            @endif
                            <label for="image_section1" class="form-label">Image</label>
                        ...
                        <div class="pb-4 col-md-6">
                            @if ($home->image1_service)
                                <img src="{{ asset('assets/home/' . $home->image1_service) }}" height="100"
                                    class="d-block">
                            @endif
                            <label for="image1_service" class="form-label">Image 1</label>
                        ...
                        <div class="pb-4 col-md-6">
                            @if ($home->image2_service)
                                <img src="{{ asset('assets/home/' . $home->image2_service) }}" height="100"
                                    class="d-block">
                            @endif
                            <label for="image2_service" class="form-label">Image 2</label>
                    ...
                    <div class="row">
                        ...
                        <div class="pb-4">
                            ...
                            <input type="text" class="form-control" id="title3_service" name="title3_service"
                                value="{{ $home->title3_service }}" />
                        </div>
                        ...
                        <div class="pb-4 col-md-6">
                            @if ($home->image3_service)
                                <img src="{{ asset('assets/home/' . $home->image3_service) }}" height="100"
                                    class="d-block">
                            @endif
                            <label for="image3_service" class="form-label">Image 3</label>
                    ...
                    <div class="row">
                        ...
                        <div class="pb-4">
                            ...
                            <input type="text" class="form-control" id="subtitle_video" name="subtitle_video"
                                value="{{ $home->subtitle_video }}" />
                        </div>

                        <div class="pb-4">
                            <label for="link_video" class="form-label">link </label>
                            <input type="text" class="form-control" id="link_video" name="link_video"
                                value="{{ $home->link_video }}" />
                        </div>
                    ...
                    <div class="divider divider-info">
                        <div class="divider-text">Section Posts</div>
                    </div>
                    <div class="row">
                        <div class="pb-4">
                            <label for="title_post" class="form-label">Title</label>
                            <input type="text" class="form-control" id="title_post" name="title_post"
                                value="{{ $home->title_post }}" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="pb-4">
                            <label for="title_contact" class="form-label">Title</label>
                            <input type="text" class="form-control" id="title_contact" name="title_contact"
                                value="{{ $home->title_contact }}" />
                        </div>
