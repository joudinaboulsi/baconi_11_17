        ...
        <div class="card-body">
            <form action="{{ route('blogDetailUpdate', $blog->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="pb-4">
                    ...
                    <input type="text" class="form-control" id="date" name="date" value="{{ $blog->date }}" />
                </div>
                ...
                <div class="pb-4">
                    ...
                    <textarea class="form-control" id="meta_title" name="meta_title">{!! $blog->meta_title !!}</textarea>
                </div>
