    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-12 col-lg-5 col-md-9 md-margin-7-rem-bottom">
                <span class="alt-font margin-20px-bottom text-gradient-sky-blue-pink d-inline-block text-uppercase font-weight-500 letter-spacing-1px">{{ $service->title_section1 }}</span>
                <h4 class="alt-font font-weight-600 text-extra-dark-gray w-95">{{ $service->subtitle_section1 }}</h4>
                <p class="w-80 lg-w-95">{!! strip_tags($service->text_section1)  !!}</p>
            ...
            <div class="col-12 col-lg-7 col-md-9 padding-55px-lr md-padding-5px-left sm-padding-50px-right">
                <figure class="image-back-offset-shadow position-right w-100">
                    <img class="border-radius-6px" src="{{ asset('assets/service/'.$service->image)}}" alt="" />
