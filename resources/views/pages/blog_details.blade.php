                    ...
                    <div class="col-12 blog-details-text last-paragraph-no-margin margin-6-rem-bottom">
                        <ul class="list-unstyled margin-2-rem-bottom">
                            <li class="d-inline-block align-middle margin-25px-right">
                                <i class="feather icon-feather-calendar text-fast-blue margin-10px-right"></i>{{ $b->date }}
                            </li>
                            <li class="d-inline-block align-middle">
                                <i class="feather icon-feather-user text-fast-blue margin-10px-right"></i>By {{ $b->by }}
                            </li>
                        </ul>
                        ...
                        <h5 class="alt-font font-weight-500 text-extra-dark-gray margin-4-half-rem-bottom pt-5">{{ $b->title }}</h5>
                        
                        <img src="{{ asset('assets/blog/'. $b->image) }}" alt="{{ $b->alt_image }}" class="w-100 border-radius-6px margin-4-half-rem-bottom" />
                        
                        <p>{!! $b->text_blog !!}</p>
                    </div>

                    <section class="padding-100px-tb md-padding-75px-tb sm-padding-30px-tb wow animate__fadeIn">
                        <div class="container">
                                ...
                                <div class="col-12 col-xl-4 col-lg-5 col-md-6 col-sm-6 text-center text-sm-start elements-social social-icon-style-09 mx-auto">
                                    <ul class="small-icon">
                                        <li class="wow animate__fadeIn" data-wow-delay="0.2s">
                                            <a class="facebook" href="https://www.facebook.com/BaconiGroup/sharer.php?u={{url()->full()}}" target="_blank"><i class="fab fa-facebook-f"></i><span></span></a>
                                        </li>
                                        <li class="wow animate__fadeIn" data-wow-delay="0.3s">
                                            <a class="instagram" href="https://www.instagram.com/baconigroup/?hl=en/share?url={{url()->full()}}" target="_blank"><i class="fab fa-instagram"></i><span></span></a>
                                        </li>
                                        <li class="wow animate__fadeIn" data-wow-delay="0.5s">
                                            <a class="linkedin" href="https://www.linkedin.com/company/baconi-group-holding/shareArticle?mini=true&url={{url()->full()}}" target="_blank"><i class="fab fa-linkedin-in"></i><span></span></a>
                                        </li>
                ...
                <div class="border-all border-color-medium-gray border-radius-4px padding-40px-all text-center margin-5-rem-bottom xs-margin-35px-bottom">
                    ...
                    <div class="social-icon-style-02 text-center">
                        <ul class="extra-small-icon">
                            ...
                            <li class="mx-0">
                                <a class="linkedin" href="{{ app('contact')->linkedin }}" target="_blank"><i class="fab fa-linkedin"></i><span></span></a>
                            </li>
                            <li class="mx-0">
                    ...
                    <ul class="latest-post-sidebar position-relative">
                        ...
                        <li class="d-flex wow animate__fadeIn" data-wow-delay="0.6s">
                            ...
                            <div class="media-body flex-grow-1">
                                <a href="{{ route('blogDetailPage',$b->id) }}" class="font-weight-500 text-extra-dark-gray d-inline-block margin-five-bottom md-margin-two-bottom">{{ Illuminate\Support\Str::limit( $b->title, 30,'..' ) }}</a>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-5 col-md-6 text-center margin-2-rem-bottom wow animate__fadeIn">
                @foreach($title as $t)
                <h5 class="alt-font font-weight-500 text-extra-dark-gray letter-spacing-minus-1px">{{$t->title}}</h5>
                @endforeach
            </div>
        </div>
        <div class="row">
