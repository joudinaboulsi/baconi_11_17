...
<section class="wow animate__fadeIn">
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-12 col-lg-6 offset-lg-1 text-center text-lg-start wow animate__fadeIn" data-wow-delay="0.4s">
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-12 col-lg-6 offset-lg-1 text-left text-lg-start wow animate__fadeIn" data-wow-delay="0.4s">
               
                <p class="w-100 md-w-80">
                    {!! $company->text3 !!}
                </p>
