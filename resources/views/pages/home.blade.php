...
@section('content')
                    ...
                    <ul>
                        ...
                        @foreach ($sliders as $slider)
                            <li data-transition="zoomout" data-slotamount="default" data-hideafterloop="0" 
                                ...
                                data-masterspeed="1500" data-thumb="http://works.themepunch.com/revolution_5_3/wp-content/"
                                data-rotate="0" data-saveperformance="off" data-title="01" data-param1="01"
                                data-description="">
                                <!-- main image -->
                                <img src="{{ asset('assets/sliders/' . $slider->background) }}" alt=""
                                    data-bgcolor="#262b32" data-bgposition="center center" data-bgfit="cover"
                                ...
                                <div class="tp-caption tp-resizeme alt-font text-white font-weight-600 text-center" 
                                    ...
                                    data-letterspacing="['-2','-1','-1','-1']" data-responsive="off"
                                    data-responsive_offset="off" data-paddingtop="['0','0','0','0']"
                                    data-paddingbottom="['15','8','8','8']" data-paddingright="['0','0','0','0']"
                                    data-paddingleft="['0','0','0','0']" style="text-shadow: 0 0 20px rgba(0, 0, 0, 0.3);">
                                    {{ $slider->title }}
                                </div>
                                ...
                                <a class="tp-caption tp-resizeme rs-btn btn btn-rounded d-flex align-items-center justify-content-center"
                                    href="{{ $slider->url }}" id="slide-411-layer-03"
                                    data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                    data-y="['middle','middle','middle','middle']" data-voffset="['152','130','82','80']"
                                    data-whitespace="nowrap" data-type="button" data-responsive="off"
                                    data-responsive_offset="off"
                                    data-frames='[{"delay":1200,"speed":1000,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[-100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
                                    data-textAlign="['center','center','center','center']"
                                    data-paddingtop="['8','8','8','8']" data-paddingbottom="['8','8','8','8']"
                                    data-paddingright="['7','7','7','7']" data-paddingleft="['34','34','34','34']"
                                    style="background-color: #2c58a7; color: #fff; font-size: 15px;">
                                    {{ $slider->link }}
                                    <div
                                        style="display: flex; justify-content: center; align-items: center; width: 38px; height: 38px; border-radius: 50%; background: #2c58a7; margin-left: 19px;">
                                        <i class="feather icon-feather-arrow-right icon-very-small right-icon"
                                            style="color: #2c58a7; font-size: 12px; line-height: 15px; margin-top: 2px; margin-left: 3px;"></i>
                                    </div>
                                </a>
                            </li>
                        @endforeach
    ...
    @foreach ($homes as $home)
        ...
        <section class="extra-big-section cover-background overflow-visible"
            style="background-image: url('{{ asset('front/images/home-startup-about-bg.jpg') }}');">
            <div class="container">
                <div class="row">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-3 col-md-6 col-sm-8 md-margin-30px-bottom xs-margin-15px-bottom">
                                ...
                                <div
                                    ...
                                    <div class="feature-box-icon margin-30px-right lg-margin-25px-right">
                                        <a href="{{ route('aboutPage') }}"> <i
                                                class="line-icon-Cursor-Click2 icon-medium text-green"></i></a>
                                    </div>
                                    <div class="feature-box-content">
                                        <a href="{{ route('aboutPage') }}">
                                            <div class="text-slate-blue font-weight-500 text-large margin-5px-bottom">
                                                {{ $home->title1 }}</div>
                            ...
                            <div class="col-12 col-lg-3 col-md-6 col-sm-8 md-margin-30px-bottom xs-margin-15px-bottom">
                                ...
                                <div
                                    ...
                                    <div class="feature-box-icon margin-30px-right lg-margin-25px-right">
                                        <a href="{{ route('aboutPage') }}"> <i
                                                class="line-icon-Bakelite icon-medium text-green"></i></a>
                                    </div>
                                    <div class="feature-box-content">
                                        <a href="{{ route('aboutPage') }}">
                                            <div class="text-slate-blue font-weight-500 text-large margin-5px-bottom">
                            ...
                            <div class="col-12 col-lg-3 col-md-6 col-sm-8">
                                ...
                                <div
                                    ...
                                    <div class="feature-box-icon margin-30px-right lg-margin-25px-right">
                                        <a href="{{ route('aboutPage') }}"> <i
                                                class="line-icon-Boy icon-medium text-green"></i></a>
                                    </div>
                                    <div class="feature-box-content">
                                        <a href="{{ route('aboutPage') }}">
                                            <div class="text-slate-blue font-weight-500 text-large margin-5px-bottom">
                ...
                <div class="row align-items-end">
                    <div
                        class="col-12 col-lg-3 col-md-6 order-1 text-center text-lg-end last-paragraph-no-margin md-margin-50px-bottom wow animate__fadeInLeft">
                        <div
                            class="title-large-2 text-green alt-font line-height-70px letter-spacing-minus-3px font-weight-600">
                            {{ $home->counter1 }}</div>
                        <span
                            class="alt-font text-extra-dark-gray font-weight-500 text-uppercase letter-spacing-2px d-block margin-15px-bottom sm-margin-5px-bottom">{{ $home->title1_count }}</span>
                    ...
                    <div class="col-12 col-lg-6 order-3 order-lg-2 text-center z-index-0 wow animate__fadeIn">
                        <div class="tilt-box"
                            ...
                            <span
                                class="text-extra-big-2 alt-font text-uppercase text-green font-weight-600 letter-spacing-minus-10px image-mask cover-background"
                                style="background-image: url('{{ asset('assets/home/' . $home->image_count) }}')">
                                {{ $home->years }}
                            </span>
                            <span
                                class="alt-font text-extra-large text-extra-dark-gray letter-spacing-4px font-weight-600 text-uppercase margin-5px-top d-block">{{ $home->title_year }}</span>
                        </div>
                    </div>
                    <div
                        class="col-12 col-lg-3 col-md-6 order-2 text-center text-lg-start order-lg last-paragraph-no-margin md-margin-50px-bottom wow animate__fadeInRight">
                        <div
                            class="title-large-2 text-green alt-font line-height-70px letter-spacing-minus-3px font-weight-600">
                            {{ $home->counter2 }}</div>
                        <span
                            class="alt-font text-extra-dark-gray font-weight-500 text-uppercase letter-spacing-2px d-block margin-15px-bottom sm-margin-5px-bottom">{{ $home->title2_count }}</span>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center overlap-section wow animate__zoomIn">
                        <img class="rounded-circle box-shadow-large w-170px h-170px border-all border-width-10px border-color-white"
                            src="{{ asset('assets/home/' . $home->logo) }}" />
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row align-items-center row-cols-1 row-cols-lg-4 row-cols-sm-2 client-logo-style-02">
                    ...
                    <div class="col text-center md-margin-50px-bottom wow animate__fadeIn">
                        <a href="{{ route('companiesPage') }}" class="client-logo"><img
                                alt="{{ $company->alt_company1 }}"
                                src="{{ asset('assets/home/' . $company->company1) }}" /></a>
                    </div>
                    <div class="col text-center md-margin-50px-bottom wow animate__fadeIn">
                        <a href="{{ route('companiesPage') }}" class="client-logo"><img
                                alt="{{ $company->alt_company2 }}"
                                src="{{ asset('assets/home/' . $company->company2) }}" /></a>
                    </div>
                    <div class="col text-center md-margin-50px-bottom wow animate__fadeIn">
                        <a href="{{ route('companiesPage') }}" class="client-logo"><img
                                alt="{{ $company->alt_company3 }}"
                                src="{{ asset('assets/home/' . $company->company3) }}" /></a>
                    </div>
                    <div class="col text-center md-margin-50px-bottom wow animate__fadeIn">
                        <a href="{{ route('companiesPage') }}" class="client-logo"><img
                                alt="{{ $company->alt_company4 }}"
                                src="{{ asset('assets/home/' . $company->company4) }}" /></a>
                    </div>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-5 col-lg-6 col-md-10 md-margin-50px-bottom">
                        <div class="col-12 p-0 margin-3-rem-bottom wow animate__fadeIn">
                            <span
                                class="alt-font font-weight-500 text-green text-extra-medium d-block margin-20px-bottom sm-margin-10px-bottom">{{ $serv->subtitle_section1 }}</span>
                            <h5 class="alt-font font-weight-600 text-extra-dark-gray d-inline-block w-90 lg-w-80 sm-w-100">
                                {{ $serv->title_section1 }}</h5>
                        </div>
                            ...
                            <div class="col-12 p-0 process-step-style-02 wow animate__fadeIn" data-wow-delay="0.2s">
                                <div class="process-step-item">
                                    ...
                                    <div class="process-content last-paragraph-no-margin">
                                        ...
                                        <p
                                            class="w-80 xs-w-100 alt-font d-block font-weight-500 text-extra-dark-gray margin-5px-bottom">
                                            {{ $serv->text_consultancy }}</p>
                                    </div>
                                </div>
                            </div>
                            <!-- end progress item -->
                    ...
                    <div class="col-12 col-lg-6 offset-xl-1 wow animate__fadeInRight">
                        <div class="outside-box-right position-relative">
                            <img src="{{ asset('assets/home/' . $serv->image_section1) }}" class="overflow-hidden"
                                alt="" style="width: 80%;" />
                        </div>
                    </div>
                </div>
                        ...
                        <div class="swiper-container black-move"
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="row m-0 h-100">
                                        <div class="col-12 col-sm-6 cover-background xs-h-200px"
                                            style="background: url('{{ asset('assets/home/' . $service->image1_service) }}');">
                                        </div>
                                        <div
                                            class="col-12 col-sm-6 d-flex padding-4-rem-all bg-white lg-padding-2-half-rem-all xs-padding-4-rem-all">
                                            <div class="align-self-center">
                                                <span
                                                    class="alt-font font-weight-500 text-uppercase text-slate-blue margin-10px-bottom d-block">{{ $service->title1_service }}</span>
                                                <p>{!! $service->p1_service !!}</p>
                                                <a href="{{ route('servicePage') }}"
                                                    class="btn btn-fancy btn-very-small btn-slate-blue"> Read more</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="row m-0 h-100">
                                        <div class="col-12 col-sm-6 cover-background xs-h-200px"
                                            style="background: url('{{ asset('assets/home/' . $service->image2_service) }}');">
                                        </div>
                                        <div
                                            class="col-12 col-sm-6 d-flex padding-4-rem-all bg-white lg-padding-2-half-rem-all xs-padding-4-rem-all">
                                            <div class="align-self-center">
                                                <span
                                                    class="alt-font font-weight-500 text-uppercase text-slate-blue margin-10px-bottom d-block">{{ $service->title2_service }}</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="row m-0 h-100">
                                        <div class="col-12 col-sm-6 cover-background xs-h-200px"
                                            style="background: url('{{ asset('assets/home/' . $service->image3_service) }}');">
                                        </div>
                                        <div
                                            class="col-12 col-sm-6 d-flex padding-4-rem-all bg-white lg-padding-2-half-rem-all xs-padding-4-rem-all">
                                            <div class="align-self-center">
                                                <span
                                                    class="alt-font font-weight-500 text-uppercase text-slate-blue margin-10px-bottom d-block">{{ $service->title3_service }}</span>
        ...
        <div class="container">
            <div class="row justify-content-center wow animate__fadeIn">
                <div
                    ...
                    @foreach ($homes as $blog)
                        <h3 class="alt-font font-weight-600 text-extra-dark-gray d-inline-block">{{ $blog->title_blog }}
                        </h3>
                    @endforeach
                </div>
            </div>
                                    ...
                                    <div class="swiper-slide interactive-banners-style-07">
                                        <div class="interactive-banners-box bg-dark-slate-blue border-radius-6px">
                                            <div class="interactive-banners-box-image">
                                                <img src="{{ asset('assets/blog/' . $blog->image) }}" alt="{{$blog->alt_image}}"
                                                    height="" />
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="alt-font text-extra-large text-white margin-15px-bottom w-60 lg-w-90 sm-w-50 xs-w-90 md-margin-5px-bottom">
                                                    {{ $blog->title }}</div>
                                                <a href="{{ route('blogDetailPage', $blog->id) }}"
                                                    class="btn btn-fancy btn-very-small btn-green btn-round-edge margin-15px-top">View
                                                    information</a>
                                            </div>
                                        </div>
                                    </div>
    ...
    @foreach ($homes as $video)
        <section class="big-section position-relative wow animate__fadeIn">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-7 col-lg-8 col-md-10 position-relative text-center padding-five-tb">
                        ...
                        <p
                            class="text-white opacity-7 alt-font text-large w-80 mx-auto line-height-32px margin-45px-bottom sm-w-100">
                            {{ $video->subtitle_video }}</p>
                    </div>
                    <div class="col-12 col-lg-8 position-relative md-margin-50px-bottom wow animate__fadeIn animate__animated"
                        data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                        <a href="{{ asset('assets/home/' . $video->video) }}"
                            class="popup-youtube absolute-middle-center video-icon-box video-icon-large pt-6">
                            <span>
            ...
            <div class="bg-video-wrapper">
                <iframe allow="autoplay" src="{{ asset('assets/home/' . $video->video) }}" frameborder="0"
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 blog-content sm-no-padding-lr">
                    <ul
                        class="blog-masonry blog-wrapper grid grid-loading grid-3col xl-grid-3col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-double-extra-large">
                        ...
                        <li class="grid-item wow animate__fadeIn">
                            <div class="blog-post border-radius-5px bg-white">
                                <div class="d-flex align-items-center font-weight-500 padding-30px-lr padding-15px-tb">
                                    ...
                                    <a href="https://www.instagram.com/p/CzT3_CnNa27/?img_index=1"
                                        class="blog-like text-extra-small text-green-hover"><i
                                            class="far fa-heart"></i><span>11</span></a>
                                   
                                </div>
                                <div class="blog-post-image">
                                    <a href="https://www.instagram.com/p/CzT3_CnNa27/?img_index=1" title=""><img
                                            src="{{ asset('assets/insta1.png') }}"
                                            alt="" /></a>
                                    {{-- <div class="alt-font blog-category"><a href="blog-masonry.html"
                                            class="text-uppercase text-green text-extra-dark-gray-hover">Fashion</a></div> --}}
                                </div>
                                <div
                                    ...
                                    <a href="https://www.instagram.com/p/CzT3_CnNa27/?img_index=1"
                                        class="alt-font font-weight-500 text-extra-medium text-extra-dark-gray text-green-hover d-block margin-15px-bottom">نحن متخصصون في مجال النقل و الخدمات اللوجستية على نطاق عالمي ورعاية محلية. تواصل مع خبرائنا اليوم!🌎📦
                                        Know more on: baconigroup.com</a>
                        ...
                        <li class="grid-item wow animate__fadeIn" data-wow-delay="0.2s">
                            <div class="blog-post border-radius-5px bg-white">
                                <div class="d-flex align-items-center font-weight-500 padding-30px-lr padding-15px-tb">
                                    ...
                                    <a href="https://www.instagram.com/p/CzbmZLcqPLy/?img_index=1"
                                        class="blog-like text-extra-small text-green-hover"><i
                                            class="far fa-heart"></i><span>16</span></a>
                                  
                                </div>
                                <div class="blog-post-image">
                                    <a href="https://www.instagram.com/p/CzbmZLcqPLy/?img_index=1" title=""><img
                                            src="{{ asset('assets/insta2.png') }}"
                                            alt="" /></a>
                                    {{-- <div class="alt-font blog-category"><a href="blog-masonry.html"
                                            class="text-uppercase text-green text-extra-dark-gray-hover">Lifestyle</a>
                                    </div> --}}
                                </div>
                                <div
                                    class="post-details padding-3-rem-lr padding-2-half-rem-tb lg-padding-2-rem-all md-padding-2-half-rem-tb md-padding-3-rem-lr">
                                    <a href="https://www.instagram.com/p/CzbmZLcqPLy/?img_index=1"
                                        class="alt-font font-weight-500 text-extra-medium text-extra-dark-gray text-green-hover d-block margin-15px-bottom">اكتشف وسائل النقل المتنوعة مع خدماتنا! انضم إلينا الآن! 🚢🚚✈️
                                        Know more on: baconigroup.com</a>
                        ...
                        <li class="grid-item wow animate__fadeIn" data-wow-delay="0.4s">
                            <div class="blog-post border-radius-5px bg-white">
                                <div class="d-flex align-items-center font-weight-500 padding-30px-lr padding-15px-tb">
                                    ...
                                    <a href="https://www.instagram.com/p/CzZBfhWoIZK/"
                                        class="blog-like text-extra-small text-green-hover"><i
                                            class="far fa-heart"></i><span>6</span></a>
                                   
                                </div>
                                <div class="blog-post-image">
                                    <a href="https://www.instagram.com/p/CzZBfhWoIZK/" title=""><img
                                            src="{{ asset('assets/insta3.png') }}"
                                            alt="" /></a>
                                ...
                                <div
                                    class="post-details padding-3-rem-lr padding-2-half-rem-tb lg-padding-2-rem-all md-padding-2-half-rem-tb md-padding-3-rem-lr">
                                    <a href="https://www.instagram.com/p/CzZBfhWoIZK/"
                                        class="alt-font font-weight-500 text-extra-medium text-extra-dark-gray text-green-hover d-block margin-15px-bottom">فرصتك لتوصيل بضائعك عبر العالم بكفاءة عالية. تواصل معنا لمعرفة المزيد! 🛩️🌎📦
                                        Know more on: baconigroup.com</a>
            ...
            <div class="row justify-content-center">
                @foreach ($homes as $contact)
                    <div class="col-12 col-xl-7 col-lg-8 col-md-10 text-center">
                        ...
                        <span
                            class="alt-font font-weight-500 text-extra-dark-gray text-uppercase letter-spacing-2px opacity-5 d-block margin-30px-bottom md-margin-20px-bottom">
                            {{ $contact->subtitle_contact }}</span>

                        <a href="{{ route('contactPage') }}"
                            class="btn btn-fancy btn-large btn-gradient-tan-geraldine btn-round-edge-small">Contact </a>
                    </div>
                @endforeach
            </div>
        </div>
