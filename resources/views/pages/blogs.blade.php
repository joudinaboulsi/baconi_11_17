...
<!-- start page title -->
<section class="half-section parallax" data-parallax-background-ratio="0.5" style="background-image:url('{{ asset('front/portfolio-bg2.jpg') }}');">
    <div class="container">
        <div class="row align-items-stretch justify-content-center extra-small-screen">
            <div class="col-12 col-xl-6 col-lg-7 col-md-8 page-title-extra-small text-center d-flex justify-content-center flex-column">
              @foreach($title as $t)
                <h2 class="text-extra-dark-gray alt-font font-weight-500 letter-spacing-minus-1px line-height-50 sm-line-height-45 xs-line-height-30 no-margin-bottom">{{$t->title}}</h2>
             @endforeach
            </div>
        </div>
    </div>
                    ...
                    <div class="blog-post bg-white box-shadow-medium margin-30px-bottom wow animate__fadeIn">
                        <div class="d-flex flex-column flex-md-row align-items-center">
                            ...
                            <div class="post-details padding-4-half-rem-lr md-padding-2-half-rem-lr sm-no-padding">
                                ...
                                <p class="margin-seventeen-bottom sm-margin-25px-bottom">{!! strip_tags(str_limit($blog->text_blog, 150,'..')) !!}</p>
                                <div class="alt-font text-extra-small text-uppercase d-flex align-items-center sm-margin-10px-bottom">
                                    <img class="avtar-image" src="images/avtar10.jpg" alt="">
                                    <span>
                                        ...
                                        {{-- <span class="d-inline-block">Read <a href="{{route('blogDetailPage',$blog->id)}}" class="text-extra-dark-gray">more</a></span> --}}
                                    </span>
                                </div>
                            </div>
                        </div>
